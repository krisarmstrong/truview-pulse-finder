...
"""
Version Bump Utility for BigRed WebSocket Client
===============================================

This script increments the patch version of the BigRed WebSocket Client project,
updates the version in BigRedWebSocketClient.py, and appends a changelog entry
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Increment BigRed WebSocket Client version and update changelog."
    )
    parser.add_argument(
        "description",
...
def increment_version(major, minor, patch):
    ...
    Returns:
        str: New version string (e.g., "3.0.1").
    """
...
def main():
    ...
    script_path = Path("BigRedWebSocketClient.py")
